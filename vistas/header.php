...
<div class="nav-no-collspan{
font-size: 15px;
}apse pull-right" id="header-nav">
<ul class="nav navbar-nav pull-left">
...
<ul class="nav nav-pills nav-stacked">
       ...
       <?php 
            if ($_SESSION['Escritorio']==1)
            {
              echo '<li>
        <a href="concepto.php">
        <img src="escritorio.png" width="35">
        <span>Inicio</span>
        </a>
        </li>';
            }
...
<img src="prestamos.png" width="35">
<span>Prestamos</span>
...
<span>Usuarios</span>
            ...
            if ($_SESSION['Gastos']==1)
            {
              echo '<li>
<a href="gastos.php">
<img src="contabilidad.png" width="35">
<span>Credito</span>
</a>
</li>';
            }
